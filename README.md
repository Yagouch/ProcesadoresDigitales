...
#include<Arduino.h>
#include <ArduinoFFT.h> //DESCARGAR LA BIBLIOTECA !!! 
...
const int FFT_SIZE = 512; // Tamaño de la FFT
double vReal[FFT_SIZE];  // Parte real de los datos de entrada de la FFT
double vImag[FFT_SIZE];  // Parte imaginaria de los datos de entrada de la FFT
double spectrum[FFT_SIZE / 2]; // Resultados de la FFT
ArduinoFFT fft; // Objeto FFT
...
// ----------WEB----------
  ...
  fft.windowFunction(AudioWindowHanning, FFT_SIZE); // Configura la ventana de la FFT
...
// Obtén los datos de entrada para la FFT (por ejemplo, desde el módulo de audio)
double inputData[FFT_SIZE];
// ... Obtén los datos de entrada desde el módulo de audio y guárdalos en inputData

// Realiza el cálculo de la FFT
fft.Compute(inputData, vReal, vImag, FFT_SIZE);
  
// Calcula el espectro de frecuencia
fft.ComplexToMagnitude(vReal, vImag, spectrum, FFT_SIZE);
  
// Utiliza los valores de spectrum para visualizar el espectro en la página web
